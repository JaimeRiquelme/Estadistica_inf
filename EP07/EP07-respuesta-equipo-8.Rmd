...
*Una vez obtenidos los datos, procedemos a verificar qué tipo de prueba estadística debemos realizar.*
...
Ahora que tenemos la muestra de los tiempos de ejecución, de todos los algoritmos de distintas instancias, procedemos a realizar el análisis estadístico pertinente.
