...
```
*Conclusión*
Dado el valor de p obtenido, siendo este de 9.497792e-63, podemos rechazar la hipótesis nula, en favor de la alternativa, por lo que podemos concluir que existen diferencias significativas en el tiempo de ejecución entre las versiones del algoritmo cuando las instancias de prueba tienen 50 o más nodos.

Debido al resultado obtenido, procederemos a realizar una prueba post-hoc para determinar cuales son las diferencias significativas entre las versiones del algoritmo.
