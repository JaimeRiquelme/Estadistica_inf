...
Dado el valor obtenido en la prueba de Shapiro-wilk de las diferencias de las muestras, siendo este mayor el nivel de significancia, podemos asumir que los datos provienen de una distribución normal, por lo que podemos realizar una prueba t de estudent, pero en este caso, para fines academicos, realizaremos una prueba no parametrica de Wilcoxon.
